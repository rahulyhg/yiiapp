...
<?php 
/*
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/jquery1.7.2.min.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/modernizr-1.7.min.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/inr.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/marrydoor.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/jquery.validationEngine.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/jquery.validationEngine-en.js');
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/formvalidation.js');

Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/marrydoor.css');
Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/global.css');
Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/validationEngine.jquery.css');
*/
?>