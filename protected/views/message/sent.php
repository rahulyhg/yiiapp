<!--main-content-->
 ...
 <p class="text_pink-hd">Messages Sent</p>
 <div class="space-35px"><p>&nbsp;<br /><br /></p></div>
             ...
             <a class="recive" href="<?php echo Utilities::createAbsoluteUrl('message','index');?>">Received</a>
              ...
              <a class="sm-send" href="<?php echo Utilities::createAbsoluteUrl('message','sent');?>">Sent</a>
                ...
                <a href="<?php echo Utilities::createAbsoluteUrl('album','index',array('mId' => $message['receiverMarryId']));?>"> <img src="<?php echo Utilities::getProfileImage($message['receiverMarryId'],$message['receiverImageName']) ?>" height="60" width="40"  border="0"/></a>
                 </div>
                  <div style="float:left; padding:5px 0px 0px 10px;">
                 <p> <span class="text_blue_b"><a href="<?php echo Utilities::createAbsoluteUrl('mypage','index');?>"><?php echo $message['receiverName']; ?></a></span></p>
