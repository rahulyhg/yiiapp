...
<a href="#"><img src="<?php echo Yii::app()->params['mediaUrl']; ?>/photo_2.jpg" class="image" border="0"/></a>
<p class="space-5px">&nbsp;</p>
 <p class="txt_bld-10"><a href="#">Make as profile picture</a>

 <p class="txt_bld-10"><a href="#" class="txt_link">Delete</a></p>
...
<a href="#"><img src="<?php echo Yii::app()->params['mediaUrl']; ?>/photo_3.jpg" class="image" border="0"/></a>
<p class="space-5px">&nbsp;</p>
 <p class="txt_bld-10"><a href="#">Make as profile picture</a>
