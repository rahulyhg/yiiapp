<div class="subContent">
			...
			<section class="subContnr">
				<ul class="accOverview pmB10">
					<form action="<?php echo Utilities::createAbsoluteUrl('mypage','photoupload'); ?>" method="post" enctype="multipart/form-data">
					<li class="mT15 mB0">
						...
						<?php foreach($photos as $photo):?>
							<div class="upCn">
								<div class="ppOpts">
									...
									<?php }else{?>
									<p><a title="click to make this ur profile picture" href="<?php echo Yii::app()->params['homeUrl']?>/mypage/photoupload/r/setimage/pId/<?php echo $photo->photoId?>/uId/<?php echo $user->userId?>">Use as Profile Picture</a></p>
									<?php }?>
									<p><a title="click to delete this picture" href="<?php echo Yii::app()->params['homeUrl']?>/mypage/photoupload/r/deleteimage/pId/<?php echo $photo->photoId?>/uId/<?php echo $user->userId?>">Delete</a></p>
								</div>
