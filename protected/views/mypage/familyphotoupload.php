<div class="subContent">
			<section class="subHead">
				<h1 class="width100 ">Upload Family Photos</h1>
			</section>
			<section class="subContnr">
				<ul class="accOverview pmB10">
					<li class="mT15 mB0">
					<form action="<?php echo Utilities::createAbsoluteUrl('mypage','familyphotoupload'); ?>" method="post" enctype="multipart/form-data" id="frmFamilyPhoto">	
						...
						<?php foreach($photos as $photo):?>
							<div class="upCn">
								...
								<span title="Passport"><?php echo Utilities::getFamilyRelationType($photo->photorelation); ?></span><br />
									<p><a title="click to delete this picture" href="<?php echo Yii::app()->params['homeUrl']?>/mypage/familyphotoupload/r/deleteimage/pId/<?php echo $photo->albumId?>/uId/<?php echo $user->userId?>">Delete</a></p>
								</div>
