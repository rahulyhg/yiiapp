<div class="subContent">
			...
			<section class="subContnr">
				<ul class="accOverview pmB10">
					<li class="mT15 mB0">
					<form action="<?php echo Utilities::createAbsoluteUrl('mypage','documentupload'); ?>" method="post" enctype="multipart/form-data"  id="frmDocuments">
						...
						<?php foreach($documents as $document):?>
							<div class="upCn">
								...
								<span title="Passport"><?php echo Utilities::getDocumentType($document->documentType)?></span>
									<a href="<?php echo Yii::app()->params['homeUrl']?>/mypage/documentupload/r/deletedocument/dId/<?php echo $document->documentId?>/uId/<?php echo $user->userId?>" title="click to delete this picture">Delete</a>
								</div>
