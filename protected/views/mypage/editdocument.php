<div class="subContent">
			<section class="subHead">
				<h1 class="width100">Edit Documents</h1>
			</section>
			<section class="subContnr">
				<ul class="accOverview pmB10">
					<li class="mT15 mB0">
					<form action="<?php echo Utilities::createAbsoluteUrl('mypage','editdocument'); ?>" method="post" enctype="multipart/form-data"  id="frmDocuments">
					...
					<li >
						...
						<?php foreach($documents as $document):?>
							<div class="upCn">
								<div class="delt">
									<a href="<?php echo Yii::app()->params['homeUrl']?>/mypage/editdocument/r/deletedocument/dId/<?php echo $document->documentId?>/uId/<?php echo $user->userId?>" title="click to delete this document">Delete</a>
								</div>
