		...
		<div class="mT40 content-section highPro">
			...
			<div class="profileR">
				...
				<div class="profile-detail">
					...
					<a href="#" class="view-full">View Full Profile</a>
				</div>
				<div class="button-contnr">
					<a class="globals" href="#">Express Interest</a>
				</div>
				<div class="button-contnr">
					<a class="globals" href="#">Bookmark</a>
					</div>
				<div class="button-contnr">
					<a class="globals" href="#">Send Message</a>
				</div>
			</div>
			<div class="profileR">
				<div class="image-contnrs">
